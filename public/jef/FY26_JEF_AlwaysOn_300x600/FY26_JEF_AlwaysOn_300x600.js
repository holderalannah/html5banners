...
tl
	...
	.fromTo("#headline", {x:-40, opacity:0 },{x: 0, opacity: 1, delay: 0.2, duration: 0.3, stagger: 1, ease: "slow(0.9, 0.1, false)" })
	.fromTo("#headline2", {x:-40, opacity:0 },{x: 0, opacity: 1, delay: 0.2, duration: 0.3, stagger: 1, ease: "slow(0.9, 0.1, false)" })
	.fromTo("#headline3", {x:-40, opacity:0 },{x: 0, opacity: 1, delay: 0.2, duration: 0.3, stagger: 1, ease: "slow(0.9, 0.1, false)" })

	.to("#firstGroup", {opacity: 0, delay: 0.15, stagger: 0.75, ease: "power1.out"})
	.fromTo("#bottle", {top: "131px" },{top: "82px",  delay: 0, duration: 0.3, stagger: 1, ease: "slow(0.9, 0.1, false)" })

	.fromTo("#headline4", {x:0, opacity:0 },{x: 0, opacity: 1, delay: 0.5, duration: 0.3, stagger: 1, ease: "power1.out" })
