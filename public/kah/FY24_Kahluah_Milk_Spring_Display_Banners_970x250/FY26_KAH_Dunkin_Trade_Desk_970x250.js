...
function build_timelines() {	
	...
	//fr1
	.add("fr1")
    .set("#badge", {x:257, y:45, width:128, height:128, opacity:0, transformOrigin: "50% 50%"})
	...
	.to("#pour", {duration:1.5, rotation: 0.9, transformOrigin: "100% 0%", top: "-163px", ease:"sine.out"})
